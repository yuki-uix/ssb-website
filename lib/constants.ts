...
export const AI_AGENTS: Agent[] = [
  ...
  },
  {
    ...
    description:
      "11-dimension listing audit and improvement engine. Rufus AEO optimization — making sure Amazon's AI recommends your brand.",
    bullets: [
  ...
  },
  {
    ...
    description: "Part of SSB's AI operations engine. Full details coming soon.",
    bullets: ["— Placeholder —"],
    placeholder: true,
  },
  {
