...
export const metadata = {
  title: 'Terms of Service | Supersonic Supply',
  description: 'Terms of Service for Supersonic Supply (Supersonic Brick LLC).',
}
    ...
    <main style={{ background: 'var(--background)' }}>
      <section className="max-w-2xl mx-auto px-6 py-32">
        ...
        >
          ...
          >
            Our Terms of Service are currently under legal review and will be published prior to launch.
            For any questions regarding terms of engagement or partnership in the meantime, please contact us directly.
          </p>
        </div>
